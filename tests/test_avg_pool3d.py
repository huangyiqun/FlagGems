...
AVGPOOL3D_CONFIGS = [
    ...
    # Basic 3x3x3 kernel
    ((2, 3, 16, 8, 4), 3, 2, 1, False, True, None),
    # count_include_pad=False
    ((2, 3, 16, 8, 4), 3, 2, 1, False, False, None),
    # Non-cubic kernel and stride
    ((4, 8, 12, 8, 4), (2, 3, 4), (1, 2, 2), (0, 1, 1), False, True, None),
    # ceil_mode
    ((2, 4, 15, 8, 4), 3, 2, 1, True, True, None),
    # divisor_override
    ((1, 1, 7, 7, 4), 2, 1, 0, False, True, 1),
    # Typical CNN shapes
    ((1, 64, 16, 8, 4), 3, 2, 1, False, True, None),
    # No padding
    ((2, 8, 8, 8, 4), 2, 2, 0, False, False, None),
    # Non-symmetric padding
    ((2, 8, 10, 8, 4), 2, 2, (0, 1, 0), False, True, None),
    # Small input
    ((1, 1, 4, 4, 4), 2, 1, 0, False, True, None),
    # Large batch
    ((8, 16, 8, 8, 4), 3, 1, 1, False, True, None),
]
