...
def sum(inp, *, dtype=None):
    logger.debug("GEMS_ENFLAME SUM GCU400")
...
def sum_out(inp, *, dtype=None, out):
    logger.debug("GEMS_ENFLAME SUM_OUT GCU400")
...
def sum_dim(inp, dim=None, keepdim=False, *, dtype=None):
    logger.debug("GEMS_ENFLAME SUM_DIM GCU400")
...
def sum_dim_out(inp, dim=None, keepdim=False, *, dtype=None, out):
    logger.debug("GEMS_ENFLAME SUM_DIM_OUT GCU400")
