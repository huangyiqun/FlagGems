...
def aminmax(inp, dim=None, keepdim=False, *, out=None):
    logger.debug("GEMS_SUNRISE AMINMAX CPU REFERENCE")
...
def aminmax_out(inp, dim=None, keepdim=False, *, out=None):
    logger.debug("GEMS_SUNRISE AMINMAX_OUT CPU REFERENCE")
    if out is None:
